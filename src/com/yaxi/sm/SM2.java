...
//	};
	...
	public SM2() 
	{
		this.ecc_p = new BigInteger(ecc_param[0], 16);//A 第一系数
		this.ecc_a = new BigInteger(ecc_param[1], 16);//B 第二系数
		this.ecc_b = new BigInteger(ecc_param[2], 16);
		this.ecc_n = new BigInteger(ecc_param[3], 16);//生产者顺序系数
		this.ecc_gx = new BigInteger(ecc_param[4], 16);//曲线X系数
		this.ecc_gy = new BigInteger(ecc_param[5], 16);//曲线Y系数
	...
	public  byte[] sm2GetZ(byte[] userId, ECPoint userKey){
		org.bouncycastle.crypto.digests.SM3Digest sm3 = new SM3Digest();
